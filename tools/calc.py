...
================================
Functions for numerical calculations that do not depend on the OSCAR data format
...
def shear_rate(f):
    """
    Calculate the shear rate of a vector field f
...
def strain_rate(f):
    """
    Calculate the strain rate of a vector field f
...
def kinetic_energy_density(f):
    """
    Calculate the kinetic energy of a vector field f
...
def enstrophy(f):
    """
    Calculate the enstrophy of a vector field f
...
def wrap_numpy_2D_vector_calc(DA_u, DA_v, selected_calculation, **kwargs):
    """
    Wrapper function for xarray to perform calculations on 2D vector fields
    ...
    **kwargs : ``dict``
        Additional keyword arguments, depending on the selected calculation
    Returns
    -------
    ``xarray.DataArray``
